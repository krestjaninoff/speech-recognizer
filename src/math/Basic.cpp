...
void Basic::printVector(double* vector, size_t size) {
	cout << "[";
...
void Basic::printVector(char* vector, size_t size) {
	cout << "[";
...
void Basic::printMatrix(double** matrix, size_t sizeX, size_t sizeY) {
...
void Basic::printMatrix3D(double*** matrix, size_t sizeX, size_t sizeY, size_t sizeZ) {
	for (size_t i = 0; i < sizeX; i++) {
		for (size_t j = 0; j < sizeY; j++) {
			cout << "\t";
